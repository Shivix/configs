...
keymap('n', "<leader>ff", ":lua require('telescope.builtin').find_files({path_display={shorten = 5}})<CR>", options)
...
keymap('n', "<leader>fb", ":lua require('telescope').extensions.file_browser.file_browser()<CR>", options)
